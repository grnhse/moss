(function () {
  ...
  describe('renderTree', function () {
    it('exists', function () {
      expect(renderTree instanceof Function).toBe(true);
    });
    ...
    it('builds a single-node AST', function() {
      ...
      expect(rootElement.childNodes[0].childNodes[0].classList.contains('ic-link')).toBe(true);
      expect(rootElement.childNodes[0].childNodes[0].innerText).toBe('Hello world');
      expect(rootElement.childNodes[0].childNodes[1].data).toBe('.');
    });
    ...
    it('supports primary links', function() {
      ...
      expect(rootElement.childNodes[0].tagName).toBe('P');
      expect(rootElement.childNodes[0].innerText).toBe(
        "Moss is a library for generating explanation trees.\n" +
        "Explanation trees have various benefits.\n");
      expect(rootElement.childNodes[0].childNodes[0].tagName).toBe('A');
      expect(rootElement.childNodes[0].childNodes[0].innerText).toBe('Moss is a library for generating explanation trees');
      expect(rootElement.childNodes[0].childNodes[0].classList.contains('ic-link')).toBe(true);
      expect(rootElement.childNodes[0].childNodes[1].data).toBe('.');
      expect(rootElement.childNodes[0].childNodes[2].tagName).toBe('BR');
      expect(rootElement.childNodes[0].childNodes[3].tagName).toBe('A');
      expect(rootElement.childNodes[0].childNodes[3].innerText).toBe('Explanation trees have various benefits');
      expect(rootElement.childNodes[0].childNodes[4].data).toBe('.');
      ...
      expect(rootElement.childNodes[1].childNodes[0].childNodes[0].classList.contains('ic-link')).toBe(true);
      expect(rootElement.childNodes[1].childNodes[0].childNodes[0].innerText).toBe('Explanation trees have various benefits');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[1].data).toBe('.');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[2].tagName).toBe('BR');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[3].data).toBe('They');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[4].data).toBe(' ');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[5].data).toBe('can');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[6].data).toBe(' ');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[7].data).toBe('have');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[8].data).toBe(' ');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[9].data).toBe('different');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[10].data).toBe(' ');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[11].data).toBe('branches');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[12].data).toBe('.');
      expect(rootElement.childNodes[1].childNodes[0].childNodes[13].tagName).toBe('BR');
    });
    ...
    it('supports secondary links', function() {
      ...
      expect(rootElement.childNodes[2].childNodes[0].childNodes[11].tagName).toBe('A');
      expect(rootElement.childNodes[2].childNodes[0].childNodes[11].innerText).toBe('explanation trees can have different branches');

      rootElement.childNodes[2].childNodes[0].childNodes[11].click();
